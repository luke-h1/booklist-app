...
// UI class: handle UI tasks (error, show alert etc.)
...
class UI {
  ...
  static deleteBook(el) {
    if (el.classList.contains('delete')) {
      el.parentElement.parentElement.remove(); // remove parent element of delete btn
    }
  }
  static showAlert(message, className) {
    ...
    setTimeout(() => {
      document.querySelector('.alert').remove(); // remove anything with alert class after 2 seconds
    }, 2000);
  }
